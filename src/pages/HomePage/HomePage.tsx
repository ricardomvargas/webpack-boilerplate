...
const Home: React.FC<HomePageProps> = ({ pageTitle }) => (
  <>
    <Topbar />
    <article className='home-page'>
      <h1>{pageTitle}</h1>
      <p className='project-intro'>
        Base web project to create applications with front end applications.
      </p>
      <section className='tools-block'>
        ...
        <a href='https://reactrouter.com/' target='_blank' title='React Router'>
          <img src='/assets/images/react-router-icon.svg' alt='react-route' />
        </a>
        <a href='https://www.typescriptlang.org/' target='_blank' title='Typescript'>
          <img src='/assets/images/typescript-icon.svg' alt='typescript' />
        </a>
        <a href='https://jestjs.io/' target='_blank' title='Jest'>
          <img src='/assets/images/jest-icon.svg' alt='jest' />
        </a>
        <a href='https://testing-library.com/' target='_blank' title='Testing Library'>
          <img src='/assets/images/testing-library-icon.svg' alt='testing-library' />
        </a>
      </section>
      <section>
        ...
        <ul>
          ...
          <li>Executing the project: npm run dev (it runs on port 3000)</li>
